...
function main() {
  ...
  const vertices = [
    ...
    { pos: [0.5, -0.5,  0.5], norm: [1,  0,  0], uv: [0.25, 0.5], }, // 50
    { pos: [0.5, -0.5, -0.5], norm: [1,  0,  0], uv: [0.75, 0.5], }, // 51
    // 6
    ...
    // 7
    { pos: [1, -0.5, -0.5],   norm: [-1,   0,  0], uv: [0.75, 0.25], }, // 56
    { pos: [1,  0.5, -0.5],   norm: [-1,   0,  0], uv: [0.75, 0.75], }, // 57
    { pos: [0.5, -0.5, -0.5], norm: [-1,   0,  0], uv: [0.5,  0.25], }, // 58
    { pos: [0.5,  0.5, -0.5], norm: [-1,   0,  0], uv: [0.5,  0.75], }, // 59
    // 8
    { pos: [0.5, -0.5, 0.5], norm: [1,  0,  0], uv: [0.5,  0.25], }, // 60
    { pos: [0.5,  0.5, 0.5], norm: [1,  0,  0], uv: [0.5,  0.75], }, // 61
    { pos: [1,   -0.5, 0.5],   norm: [1,  0,  0], uv: [0.25, 0.25], }, // 62
    { pos: [1,    0.5, 0.5],   norm: [1,  0,  0], uv: [0.25, 0.75], }, // 63
    // back
